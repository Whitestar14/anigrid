                     ...
                     <SettingRow
                           ...
                           <div className="flex items-center gap-2">
                               {editingId === rank.id ? (
                                   ...
                                   <div className="flex items-center gap-2 min-w-0">
                                       <h4 className={`truncate ${rank.id === activeRankId ? 'text-blue-400' : 'text-white'}`}>
                                           {rank.title}
                                       </h4>
                                       <button
                       ...
                       right={
                           <>
                               ...
                               <div className="text-white/20 group-hover:text-white/40 transition-colors ml-1">
                                   <ChevronRight size={16} strokeWidth={2} />
                               </div>
                           </>
                       }
                       className={rank.id === activeRankId ? 'bg-blue-500/10 hover:bg-blue-500/20' : 'hover:bg-white/10'}
                     />
                   </motion.div>
                 ))}
               </AnimatePresence>
