    ...
    return (
      <div
        ...
        style={{
          ...
          width: ctrl.isExpanded ? "var(--expanded-dock-width, calc(100% - 16px))" : "auto",
      ...
      >
        ...
        `}
          style={{
            width: ctrl.isExpanded ? "100%" : "clamp(220px, calc(100vw - 120px), 310px)",
        ...
        >
          <div
            className={`absolute left-0 right-0 top-0 flex items-stretch px-2 py-1.5 h-[3rem] gap-1 transition-opacity duration-200 ${!ctrl.isExpanded ? "opacity-100 pointer-events-auto delay-75" : "opacity-0 pointer-events-none"}`}
          >
            <button
              type="button"
          ...
          {/* ── Expanded surfaces ───────────────────────────── */}
          <div
            className={`flex flex-col w-full h-[28rem] transition-opacity duration-200 ${ctrl.isExpanded ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}
          >
              ...
              <>
                ...
                <div className="flex-1 overflow-hidden relative flex flex-col min-h-0 bg-surface-secondary">
                  <div className="flex-1 min-h-0 flex flex-col relative">
                    ...
                    <div
                      className={`flex-1 min-h-0 ${ctrl.activeTab === "search" ? "flex flex-col" : "hidden"}`}
                    >
                      <InboxSearchView
                    ...
                    <div
                      className={`flex-1 min-h-0 ${ctrl.activeTab === "stash" ? "flex flex-col" : "hidden"}`}
                    >
                      <InboxStashView
                        ...
                        onMoveItemsToCollection={(targetId) => {
                          ctrl.moveItemsToCollection(Array.from(ctrl.selectedItemIds), targetId);
                          ctrl.setSelectedItemIds(new Set());
                          useStore.getState().setInteractionState(null);
                        }}
